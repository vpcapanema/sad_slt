<?xml version="1.0" encoding="UTF-8"?><sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0">
    <sld:NamedLayer>
        <sld:Name>InventarioFlorestal2010</sld:Name>
        <sld:UserStyle>
            <sld:Name>STI_inventflore2010</sld:Name>
            ...
            <sld:FeatureTypeStyle>
                ...
                <sld:Rule>
                    ...
                    <ogc:Filter>
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>DLEGNDMAPA</ogc:PropertyName>
                ...
                <sld:Rule>
                    ...
                    <ogc:Filter>
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>DLEGNDMAPA</ogc:PropertyName>
                            <ogc:Literal>Formação Arbórea / Arbustiva-Herbácea de Terrenos Marinhos Lodosos</ogc:Literal>
                        </ogc:PropertyIsEqualTo>
                    </ogc:Filter>
                    <sld:PolygonSymbolizer>
                        <sld:Fill>
                ...
                <sld:Rule>
                    <sld:Name>Formação Arbórea / Arbustiva em Região de Várzea</sld:Name>
                    <sld:Title>Formação Arbórea / Arbustiva em \n Região de Várzea</sld:Title>
                    <ogc:Filter>
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>DLEGNDMAPA</ogc:PropertyName>
                            <ogc:Literal>Formação Arbórea / Arbustiva em Região de Várzea</ogc:Literal>
                        </ogc:PropertyIsEqualTo>
                    </ogc:Filter>
                    <sld:PolygonSymbolizer>
                        <sld:Fill>
                ...
                <sld:Rule>
                    <sld:Name>Formação Pioneira Arbustiva-Herbácea sobre Sedimentos Marinhos Recentes</sld:Name>
                    <sld:Title>Formação Pioneira Arbustiva-Herbácea sobre \n Sedimentos Marinhos Recentes</sld:Title>
                    <ogc:Filter>
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>DLEGNDMAPA</ogc:PropertyName>
                            <ogc:Literal>Formação Pioneira Arbustiva-Herbácea sobre Sedimentos Marinhos Recentes</ogc:Literal>
                        </ogc:PropertyIsEqualTo>
                    </ogc:Filter>
                    <sld:PolygonSymbolizer>
                        <sld:Fill>
