"""Acesso a dados — demandas.projeto."""
...
_SELECT_BASE = """
    SELECT
        ...
        d.instituicao_nome,
        d.instituicao_cnpj,
        d.instituicao_razao_social,
        d.instituicao_nome_fantasia,
        d.sigma_pessoa_id,
...
_INSERT_SQL = """
    INSERT INTO demandas.projeto (
        ...
        instituicao_nome,
        instituicao_cnpj,
        instituicao_razao_social,
        instituicao_nome_fantasia,
        sigma_pessoa_id,
        representante_nome,
        representante_email,
        ...
        %(instituicao_nome)s,
        %(instituicao_cnpj)s,
        %(instituicao_razao_social)s,
        %(instituicao_nome_fantasia)s,
        %(sigma_pessoa_id)s,
