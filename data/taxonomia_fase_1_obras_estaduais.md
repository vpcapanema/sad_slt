...
| Infraestrutura e servidoes | Interferencias fisicas e faixas instituidas de redes e ativos estruturantes. | Rodovia, ferrovia, dutovia, linha de transmissao, aeroporto, barragem, faixa de dominio, servidao administrativa. | Restricao e risco | Sim | Dimensao essencial para detectar conflito fisico, remanejamento e compatibilizacao. |
...
| Faixa de dominio ou servidao | Risco de interferencia | Norma de seguranca, dominio ou operador que impeca cruzamento, compartilhamento ou remanejamento. |
