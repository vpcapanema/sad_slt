...
(function () {
  ...
  const ALIAS = {
    ...
    relatorio_fase1: "Relatório da Elegibilidade territorial",
    relatorio_fase2: "Relatório da Favorabilidade de grade e da rede",
    relatorio_fase3: "Relatório da Priorização por atributos",
  ...
  const TOKEN = {
    ...
    atributo: "Atributo", fase1: "Elegibilidade territorial", fase2: "Favorabilidade de grade e da rede", fase3: "Priorização por atributos",
  ...
  const TABELA_ALIAS = {
    ...
    regra_classificacao_fase1: "Regras de Classificação (Elegibilidade territorial)",
    ...
    produto_homologado_fase1: "Produtos Homologados (Elegibilidade territorial)",
    configuracao_fatiamento_fase1: "Configuração de Fatiamento (Elegibilidade territorial)",
    configuracao_fluxo_item: "Itens da Configuração de Fluxo",
    configuracao_fluxo: "Configuração de Fluxo", criterio_fase2: "Critérios (Favorabilidade de grade e da rede)",
    produto_criterio_fase2: "Critérios do Produto (Favorabilidade de grade e da rede)",
    atributo_fase3: "Atributos (Priorização por atributos)", rodada_fase3: "Rodadas (Priorização por atributos)",
    fonte_fase1: "Fontes (Elegibilidade territorial)", portal_favorito_usuario: "Favoritos do Portal por Usuário",
