(function () {
  ...
  function load() { return Promise.all([api(appPrefix + "/" + "api/ahp/comparacao-colaborativa/ambientes/" + id), api(appPrefix + "/" + "api/ahp/comparacao-colaborativa/ambientes/" + id + "/respostas"), api(appPrefix + "/" + "api/ahp/hierarquizacoes"), api(appPrefix + "/" + "api/ahp/comparacao-colaborativa/ambientes")]).then(function (v) { julgamento = v[0]; respostas = v[1]; hierarquia = v[2].find(function (h) { return h.id === julgamento.hierarquizacao_id; }); julgamentos = v[3]; render(); }); }
