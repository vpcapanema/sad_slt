(function () {
  ...
  function render() {
    ...
    window.renderTabelaColaborativa("ami-workspace-database", julgamentos, function (j) { return { href: appPrefix + "/restrict/analise-multicriterio/julgamentos/" + encodeURIComponent(j.id) + "/", label: j.id === id ? "Atual" : "Abrir" }; });
  }
